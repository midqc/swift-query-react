...
const Newtab = () => {
  ...
  return (
    <>
      <Wallpaper themeName={theme} mode={useThemeContext(divThemeRef.current)} />
      ...
      <div className="App font-default-regular overflow-hidden h-screen w-screen" ref={divThemeRef}>
          <SearchBar/>
